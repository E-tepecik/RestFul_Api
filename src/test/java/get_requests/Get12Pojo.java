...
public class Get12Pojo extends RestfulBaseUrl {
    ...
    public void get12Pojo(){
        ...
        //Send the Request and Get the Response//get yapacağımız için bodye gerek yok
        Response response = given().spec(spec).when().get("/{first}/{second}");
        response.prettyPrint();

        //Do Assertion//data göndermeyeceğimiz için contenttype gerek yok//de seriazation yapıp BookingPojo data tipine çevirdik.
