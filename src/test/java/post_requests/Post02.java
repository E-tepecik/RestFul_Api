...
public class Post02 extends RestfulBaseUrl {
    ...
    public void post02(){
        ...
        //((Map)actualData.get("booking")) önce map e çeviriyoruz çünkü bir obje. get diyemiyoruz mape çevirmeden
        //bodyle yapabilirdik ama kullanamazdık.//test datasını assertion yazmak hard coding olur. dinamik olmaz
        //neden repır classlar giriyoruz Integer gibi null değerler girebilmek için
